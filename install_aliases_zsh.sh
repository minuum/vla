...
# =============================================================================
# 🚀 Install ROS2 Aliases to Zsh .zshrc
# zsh용 ROS2 별칭을 자동으로 추가하는 스크립트
# =============================================================================

echo "==============================================================================="
echo "🚀 Install ROS2 Aliases to Zsh .zshrc"
echo "==============================================================================="
...
if ! grep -q "# ROS2 Mobile VLA Aliases" ~/.zshrc; then
    ...
    echo "run_vla_collector() { setup_ros2_env; echo \"📊 VLA 데이터 수집 노드 실행 중...\"; ros2 run mobile_vla_package mobile_vla_data_collector.py }" >> ~/.zshrc
    echo "run_vla_inference() { setup_ros2_env; echo \"🧠 VLA 추론 노드 실행 중...\"; ros2 run mobile_vla_package vla_inference_node.py }" >> ~/.zshrc
    echo "" >> ~/.zshrc
...
# 3. 완료 메시지
echo ""
echo "🎉 ROS2 Zsh Aliases Installation 완료!"
