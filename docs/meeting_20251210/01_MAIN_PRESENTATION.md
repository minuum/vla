...
**전체**: 16개 | **완료**: 7개 (43.75%) | **미수행**: 9개

| ID | Data | Chunk | Strategy | 상태 | Val Loss | 순위 | 비고 |
|:---:|:---|:---:|:---|:---:|---:|:---:|:---|
| **5** 🏆 | L+R (500) | **1** | Baseline | ✅ | **0.000532** | 1 | **Best!** |
| 8 | L+R (500) | 1 | Abs | ✅ | 0.00243 | 2 | - |
| 9 | L+R (500) | 1 | Aug+Abs | ✅ | 0.004 | 3 | - |
| 4 | R (250) | 10 | Baseline | ✅ | 0.016 | 4 | Data 비교 |
| 1 | L+R (500) | 10 | Baseline | ✅ | 0.027 | 5 | Baseline |
| 2 | L+R (500) | 10 | Fixed | ✅ | 0.048 | 6 | Xavier init |
