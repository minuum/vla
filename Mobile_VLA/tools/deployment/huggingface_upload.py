#!/usr/bin/env python3
"""
Hugging Face에 Mobile VLA 모델 업로드 스크립트
...
# Load model
model = AutoModel.from_pretrained("your-username/mobile-vla-omniwheel")
tokenizer = AutoTokenizer.from_pretrained("your-username/mobile-vla-omniwheel")
...
def upload_to_huggingface():
    ...
    try:
        ...
        print(f"📦 저장소 생성 중: {full_repo_name}")
        ...
        try:
            ...
            print(f"⚠️ 저장소 생성 중 오류 (이미 존재할 수 있음): {e}")
        ...
        print("💡 해결 방법:")
        print("1. huggingface_hub 설치: pip install huggingface_hub")
        print("2. 로그인: huggingface-cli login")
        print("3. 토큰 설정: export HF_TOKEN=your_token")
...
def main():
    ...
    """
    print("=" * 60)
    print("🤖 Mobile VLA 모델 Hugging Face 업로드")
    print("=" * 60)
