#!/usr/bin/env python3
"""
Training Script for Enhanced Kosmos2+CLIP Hybrid Model with Simple Claw Matrix
Vision Resampler, CLIP Normalization, Simple Claw Matrix를 통합한 모델 학습
...
from enhanced_kosmos2_clip_hybrid_with_simple_claw_matrix import EnhancedKosmos2CLIPHybridWithSimpleClawMatrix
...
class Original72EpisodesDataset(Dataset):
    """Original 72 episodes dataset with claw matrix support"""
...
def train_enhanced_model_with_simple_claw_matrix(
    ...
    """Train the enhanced model with simple claw matrix"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train Enhanced Kosmos2+CLIP Hybrid Model with Simple Claw Matrix")
    ...
    parser.add_argument("--save_dir", type=str, default="checkpoints_claw_matrix", help="Directory to save checkpoints")
    parser.add_argument("--normalization_type", type=str, default="mobile", choices=["mobile", "adaptive"],
                        help="CLIP normalization type")
    parser.add_argument("--claw_matrix_type", type=str, default="mobile", choices=["mobile", "simple"],
                        help="Claw matrix type")
    ...
    # Create model
    logger.info("Creating Enhanced Kosmos2+CLIP Hybrid Model with Simple Claw Matrix...")
    model = EnhancedKosmos2CLIPHybridWithSimpleClawMatrix(
        ...
        claw_matrix_type=args.claw_matrix_type
    )
    ...
    history, best_val_mae = train_enhanced_model_with_simple_claw_matrix(
        model=model,
