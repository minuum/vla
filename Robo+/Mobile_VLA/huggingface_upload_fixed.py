#!/usr/bin/env python3
"""
Hugging Face에 Mobile VLA 모델 업로드 스크립트 (수정판)
...
def upload_to_huggingface():
    ...
    try:
        ...
        print("💡 해결 방법:")
        print("1. https://huggingface.co/minuum/mobile-vla-omniwheel 에서 저장소 생성")
...
def main():
    ...
    """
    print("=" * 60)
    print("🤖 Mobile VLA 모델 Hugging Face 업로드 (수정판)")
    print("=" * 60)
