...
## [Abstract]
This paper proposes a mobile-optimized Vision-Language-Action (VLA) model for real-time robot navigation. We present a hybrid architecture that combines Kosmos-2 and CLIP vision-language models with an LSTM-based policy head to achieve real-time inference on Jetson Orin NX while maintaining high accuracy (MAE < 0.25). Our approach demonstrates the effectiveness of Policy-Head-Continuous-Action paradigm for mobile robot applications.

**Key words:** Mobile VLA, Real-time Navigation, Hybrid Architecture, Kosmos-2, CLIP, LSTM Policy Head

## [요약]
본 논문은 모바일 환경에 최적화된 Vision-Language-Action (VLA) 모델을 제안한다. Kosmos-2와 CLIP을 조합한 하이브리드 아키텍처와 LSTM 기반 정책 헤드를 사용하여 Jetson Orin NX에서 실시간 추론과 높은 정확도(MAE < 0.25)를 달성하였다. Policy-Head-Continuous-Action 패러다임을 적용하여 모바일 로봇 내비게이션에 최적화된 시스템을 구현하였다.
...
본 연구의 주요 목표는 모바일 환경에 최적화된 VLA 모델을 개발하는 것이다. 구체적으로는 Jetson Orin NX 16GB에서 실시간 동작 가능한 VLA 모델을 구현하여, MAE 0.25 이하의 성능을 달성하는 것을 목표로 한다.
...
기존 VLA 모델들이 가진 한계점을 분석한 결과는 다음과 같다.
...
기존 VLA 모델들은 주로 고성능 컴퓨팅 환경에서의 실험에 집중하여, 모바일 환경이나 엣지 디바이스에서의 실시간 처리는 어려움이 있다. 또한, 기존 모델들은 주로 로봇팔 제어에 집중하여 모바일 로봇 내비게이션에는 직접적으로 적용하기 어려운 경우가 많다.
...
첫째, 모바일 환경에 최적화된 VLA 모델 개발에 성공하였다. Jetson Orin NX 16GB 환경에서 실시간 동작 가능한 VLA 모델을 구현하여, MAE 0.25 이하의 성능을 달성하였다. 이는 기존의 대규모 VLA 모델들이 가진 계산 복잡도와 실시간성 문제를 해결한 중요한 성과이다.
...
[2] Y. Du, T. Fu, Z. Chen, B. Li, S. Su, Z. Zhao, and C. Wang, "VL-Nav: Real-time Vision-Language Navigation with Spatial Reasoning," arXiv preprint arXiv:2502.00931, 2025.
...
[4] W. Li, R. Zhang, R. Shao, J. He, and L. Nie, "CogVLA: Cognition-Aligned Vision-Language-Action Model via Instruction-Driven Routing & Sparsification," arXiv preprint arXiv:2508.21046, 2025.

[5] A. Payandeh, A. Pokhrel, D. Song, M. Zampieri, and X. Xiao, "Narrate2Nav: Real-Time Visual Navigation with Implicit Language Reasoning in Human-Centric Environments," arXiv preprint arXiv:2506.14233, 2025.

[6] Z. Kong, D. Xu, Z. Li, P. Dong, H. Tang, Y. Wang, and S. Mukherjee, "AutoViT: Achieving Real-Time Vision Transformers on Mobile via Latency-aware Coarse-to-Fine Search," International Journal of Computer Vision, 2025.

[7] A. Radford, J. W. Kim, C. Hallacy, A. Ramesh, G. Goh, S. Agarwal, G. Sastry, A. Askell, P. Mishkin, J. Clark, G. Krueger, and I. Sutskever, "Learning Transferable Visual Models From Natural Language Supervision," in International Conference on Machine Learning, 2021, pp. 8748-8763.

[8] H. Su, W. Shi, J. Kasai, Y. Wang, Y. Hu, M. Ostendorf, W. Yih, N. Smith, L. Zettlemoyer, and T. Yu, "One Embedder, Any Task: Instruction-Finetuned Text Embeddings," arXiv preprint arXiv:2212.09741, 2022.

[9] S. Huang, L. Dong, W. Wang, Y. Hao, S. Singhal, S. Ma, T. Lv, L. Cui, O. K. Mohammed, Q. Liu, K. Aggarwal, D. J. Jain, S. Gao, and F. Wei, "Language Is Not All You Need: Aligning Perception with Language Models," arXiv preprint arXiv:2302.14045, 2023.

[10] A. Brohan, N. Brown, J. Carbajal, Y. Chebotar, J. Dabis, C. Finn, K. Gopalakrishnan, K. Hausman, A. Herzog, J. Hsu, J. Ibarz, B. Ichter, A. Irpan, T. Jackson, S. Jesmonth, N. J. Joshi, R. Julian, D. Kalashnikov, Y. Kuang, I. Leichty, S. Levine, Y. Lu, U. Malla, D. Manjunath, I. Mordatch, O. Nachum, C. Parada, J. Peralta, E. Perez, K. Pertsch, J. Quiambao, K. Rao, M. Ryoo, G. Salazar, P. Sanketi, P. Sermanet, J. Sievers, C. Summers, M. T. Tan, A. Toshev, V. Vanhoucke, F. Xia, T. Xiao, P. Xu, S. Xu, and M. Yan, "RT-2: Vision-Language-Action Models Transfer Web Knowledge to Robotic Control," arXiv preprint arXiv:2307.15818, 2023.

[11] D. Shah, B. Osiński, S. Levine, and B. Ichter, "LM-Nav: Robotic Navigation with Large Pre-Trained Models of Language, Vision, and Action," in Conference on Robot Learning, 2022, pp. 492-504.

[12] M. Ahn, A. Brohan, N. Brown, Y. Chebotar, O. Cortes, B. David, C. Finn, C. Fu, K. Gopalakrishnan, K. Hausman, A. Herzog, D. Ho, J. Hsu, J. Ibarz, B. Ichter, A. Irpan, E. Jang, R. Julian, D. Kalashnikov, Y. Kuang, I. Leichty, S. Levine, Y. Lu, U. Malla, D. Manjunath, I. Mordatch, O. Nachum, C. Parada, J. Peralta, E. Perez, K. Pertsch, J. Quiambao, K. Rao, M. Ryoo, G. Salazar, P. Sanketi, P. Sermanet, J. Sievers, C. Summers, M. T. Tan, A. Toshev, V. Vanhoucke, F. Xia, T. Xiao, P. Xu, S. Xu, and M. Yan, "Do As I Can, Not As I Say: Grounding Language in Robotic Affordances," arXiv preprint arXiv:2204.01691, 2022.
