...
최근 로봇 비전-언어 모델(RoboVLMs)은 다양한 로봇 응용 분야에서 주목받고 있다. 그러나 기존 RoboVLMs는 멀티모달 상호작용 구조의 제한, 행동 토크나이징 및 학습 목표의 미탐색 등 여러 한계점을 지니고 있다. 본 연구의 목적은 이러한 한계점을 분석하고, 개선된 아키텍처를 제안하여 실시간 로봇 내비게이션의 성능을 향상시키는 것이다.

이를 위해, 우리는 기존 RoboVLMs의 구조적 제한을 식별하고, 멀티모달 상호작용의 효율성을 높이기 위한 새로운 모델을 설계한다. 또한, 행동 토크나이징 기법과 학습 목표를 재정의하여 모델의 일반화 능력을 강화하고자 한다. 최종적으로, 제안된 모델의 성능을 다양한 실험을 통해 검증하고, 기존 모델과의 비교를 통해 그 우수성을 입증한다.

이러한 연구를 통해 로봇 비전-언어 모델의 한계를 극복하고, 실시간 로봇 내비게이션의 효율성과 정확도를 향상시키는 데 기여하고자 한다.
...
**3.3.3 배치 처리 최적화**
배치 크기 2를 사용하여 메모리 사용량을 제한하면서도 효과적인 학습을 수행한다. Adam 옵티마이저와 10-15 에포크의 학습으로 안정적인 수렴을 보장한다.

---

## IV. Experimental Results

본 연구에서는 제안하는 Mobile VLA 시스템의 성능을 다양한 실험을 통해 검증하였다.

### 1. 실험 환경 및 설정

본 연구의 실험은 NVIDIA Jetson Orin NX 16GB 환경에서 수행되었다. Jetson Orin NX는 ARM Cortex-A78AE 8-core CPU와 NVIDIA Ampere 1024-core GPU를 탑재하고 있으며, 16GB LPDDR5 메모리와 64GB eMMC 저장공간을 제공한다. 소프트웨어 환경은 Ubuntu 22.04 LTS 운영체제, Python 3.10, PyTorch 2.0+, ROS2 Humble, CUDA 12.0로 구성되었다.
...
[3] A. Brohan, Y. Chebotar, C. Finn, K. Hausman, K. Gopalakrishnan, A. Irpan, P. Sermanet, S. Levine, "RT-1: Robotics Transformer for Real-World Control at Scale," Conference on Robot Learning, 2023.

[4] D. Shah, B. Osiński, S. Levine, "LM-Nav: Robotic Navigation with Large Pre-Trained Models of Language, Vision, and Action," Conference on Robot Learning, 2022.

[5] Y. Ma, D. Jayaraman, O. Bastani, "VL-Nav: Vision-and-Language Navigation in the Real World," Conference on Computer Vision and Pattern Recognition, 2023.

[6] Y. Jiang, A. Gupta, Z. Zhang, G. Wang, Y. Dou, Y. Chen, L. Fei-Fei, A. Anandkumar, Y. Zhu, L. Fan, "MoManipVLA: Mobile Manipulation with Vision-Language-Action Models," arXiv preprint arXiv:2310.10221, 2023.

[7] S. Huang, W. Xiong, W. Y. Wang, "CogVLA: Vision-Language-Action Model for Cognitive Robots," arXiv preprint arXiv:2311.00899, 2023.

[8] A. Majumdar, A. Shrivastava, S. Lee, P. Anderson, D. Batra, D. Parikh, "Narrate2Nav: Navigate Like a Human," Conference on Computer Vision and Pattern Recognition, 2020.

[9] A. Radford, J. W. Kim, C. Hallacy, A. Ramesh, G. Goh, S. Agarwal, G. Sastry, A. Askell, P. Mishkin, J. Clark, G. Krueger and I. Sutskever, "Learning Transferable Visual Models From Natural Language Supervision," International Conference on Machine Learning, 2021.

[10] H. Touvron, M. Cord, M. Douze, F. Massa, A. Sablayrolles, H. Jegou, "Training data-efficient image transformers & distillation through attention," International Conference on Machine Learning, 2021.

[11] A. Dosovitskiy, L. Beyer, A. Kolesnikov, D. Weissenborn, X. Zhai, T. Unterthiner, M. Dehghani, M. Minderer, G. Heigold, S. Gelly, J. Uszkoreit, N. Houlsby, "An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale," International Conference on Learning Representations, 2021.

[12] K. He, X. Zhang, S. Ren and J. Sun, "Deep Residual Learning for Image Recognition," The Computer Vision and Pattern Recognition, Dec 2015. https://doi.org/10.48550/arXiv.1512.03385

[13] A. Vaswani, N. Shazeer, N. Parmar, J. Uszkoreit, L. Jones, A. N. Gomez, L. Kaiser and I. Polosukhin, "Attention Is All You Need," 31st Conference on Neural Information Processing Systems, Long Beach, CA, USA, Jun 2017. https://doi.org/10.48550/arXiv.1706.03762

[14] J. Devlin, M. W. Chang, K. Lee, K. Toutanova, "BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding," North American Chapter of the Association for Computational Linguistics, 2019.
