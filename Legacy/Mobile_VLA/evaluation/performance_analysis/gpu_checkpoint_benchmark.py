...
class GPUCheckpointBenchmark:
    ...
    def run_all_checkpoints_benchmark(self):
        """모든 체크포인트 벤치마크 실행"""
        logger.info("🚀 GPU 환경에서 모든 체크포인트 벤치마킹 시작")
        ...
        if results:
            ...
            # 결과 저장
            output_path = "results/gpu_checkpoints_benchmark_results.json"
...
def main():
    benchmark = GPUCheckpointBenchmark()
