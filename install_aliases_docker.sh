...
# =============================================================================
# 🐳 Install ROS2 Aliases to Docker Container .bashrc
# Docker 컨테이너의 .bashrc에 ROS2 별칭을 자동으로 추가하는 스크립트
# =============================================================================

echo "==============================================================================="
echo "🐳 Install ROS2 Aliases to Docker Container .bashrc"
echo "==============================================================================="
...
if ! grep -q "# ROS2 Mobile VLA Aliases" ~/.bashrc; then
    ...
    echo "    if [ -f \"/workspace/vla/ROS_action/install/setup.bash\" ]; then" >> ~/.bashrc
    echo "        source /workspace/vla/ROS_action/install/setup.bash" >> ~/.bashrc
    echo "    fi" >> ~/.bashrc
    echo "}" >> ~/.bashrc
    echo "" >> ~/.bashrc
    ...
    echo "check_container() { echo \"🔍 컨테이너 상태 확인 중...\"; echo \"📋 호스트명: \$(hostname)\"; echo \"📋 IP 주소: \$(hostname -I)\"; echo \"📋 현재 디렉토리: \$(pwd)\"; }" >> ~/.bashrc
    ...
    echo "    echo \"   check_container      : 컨테이너 상태 확인\"" >> ~/.bashrc
...
# 3. 완료 메시지
echo ""
echo "🎉 ROS2 Docker Aliases Installation 완료!"
